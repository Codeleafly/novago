# Advanced Tips & Tricks in NovaGo

This document highlights undocumented edge cases, optimizations, and deep execution tricks for leveraging NovaGo's core architecture gracefully.
...
NovaGo native logic supports recursive descent parsing efficiently. Arrays are passed automatically *by reference*, making queue handling extremely quick:
...
NovaGo relies natively on Functional closures instead of native Class directives.
